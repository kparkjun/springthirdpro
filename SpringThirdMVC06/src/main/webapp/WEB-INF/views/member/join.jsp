...
<div class="container">
  ...
  <div class="panel panel-default">
      ...
      <form name="frm" action="${contextPath}/memRegister.do" method="post">
         ...
         <table class="table table-bordered" style="text-align: center; border:1px solid #dddddd;">
           <tr>
             ...
             <td><input id="memID" name="memID" class="form-control" type="text" maxlength="20" placeholder="아이디를 입력하새요."/></td>
             <td style="width:110px; vertical-align: middle;"><button type="button" class="btn btn-primary btn-sm" onclick="registerCheck()">중복확인</button></td>
           </tr>
           <tr>
    ...
    <div class="panel-footer">스프1탄_인프런(박준호)</div>
  </div>
</div>
