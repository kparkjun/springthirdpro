      ...
      <c:if test="${!empty mvo }">
	      <ul class="nav navbar-nav navbar-right">
			    ...
			    <c:if test="${empty mvo.memProfile}">
			     <li></a> <img class="img-circle" src="${contextPath}/resources/images/person.png" style="width:50px; height:50px"/> ${mvo.memName} 님Welcome.</li>
			    </c:if>
			    <c:if test="${!empty mvo.memProfile}">
			     <li></a> <img class="img-circle" src="${contextPath}/resources/upload/${mvo.memProfile}" style="width:50px; height:50px"/> ${mvo.memName} 님Welcome.</li>
			    </c:if>
